...
- The following functions accept either scalars or array‑like inputs (any mix, via NumPy
  ...
  - calculate_vega, (and also the other functions I commented out, which aren't used in this project)
...
# i left the other Greeks functions here, commented out, incase you want to use them for some reason
